...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Should handle exceptions in before test run (scenarios in same feature)")]
        public virtual void ShouldHandleExceptionsInBeforeTestRunScenariosInSameFeature()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Should handle exceptions in before test run (scenarios in same feature)", ((string[])(null)));
#line 82
this.ScenarioSetup(scenarioInfo);
#line hidden
#line 83
...
#line 93
 testRunner.And("a hook \'HookForBeforeTestRun\' for \'BeforeTestRun\' that fails for the first time");
#line 94
 testRunner.And("all steps are bound and pass");
#line 95
 testRunner.When("I execute the tests");
#line 96
 testRunner.Then("the hook \'HookForBeforeTestRun\' is executed once");
#line hidden
            this.ScenarioCleanup();
        }
        
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Should handle exceptions in before test run (scenarios in different features)")]
        public virtual void ShouldHandleExceptionsInBeforeTestRunScenariosInDifferentFeatures()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Should handle exceptions in before test run (scenarios in different features)", ((string[])(null)));
#line 99
this.ScenarioSetup(scenarioInfo);
#line hidden
#line 100
