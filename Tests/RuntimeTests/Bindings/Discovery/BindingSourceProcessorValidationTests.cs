...
namespace TechTalk.SpecFlow.RuntimeTests.Bindings.Discovery
{
    ...
    {
        class BindingSourceProcessorValidationStub : BindingSourceProcessor
        {
            public BindingSourceProcessorValidationStub() : base(new BindingFactory(new StepDefinitionRegexCalculator(new RuntimeConfiguration())))
            {
            }
        ...
        public void Setup()
        {
            this.BindingSourceProcessorUnderTest = new BindingSourceProcessorValidationStub();
